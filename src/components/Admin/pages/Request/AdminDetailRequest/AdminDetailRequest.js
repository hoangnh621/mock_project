...
import { approvedAdmin } from '../../../../../store/reducer/adminRequest'
import {
  adminRequestDetail,
  getAdminDetailState,
} from '../../../../../store/reducer/adminRequestDetailSlice'
import './AdminDetailRequest.scss'

const AdminDetailRequest = ({ currentRow, toggle, setToggle }) => {
  const dispatch = useDispatch()
  const requestDetail = useSelector(getAdminDetailState)
  const [textAreaValue, setTextAreaValue] = useState('')

  useEffect(() => {
    dispatch(adminRequestDetail(currentRow.id))
